...
<div class="header" id="header"><img src="web/images/logo.png" width="342" height="104" /><br />
  ...
  Por favor complete con sus datos, muchas gracias.<br />
</div>
<br />
...
<div class="mod-contacto1" id="mod-contacto1">
Provincia / Estado:
<input name="provincia-estado" type="text" id="provincia-estado" size="28" /></div>
...
<div class="mod-contacto1" id="mod-contacto1">Tel&eacute;fono Laboral:
...
<?php
  ...
  $mensaje.= "\nCiudad: ". $_POST['ciudad'];
  $mensaje.= "\nProvincia-estado: ". $_POST['provincia-estado'];
  $mensaje.= "\nCelular: ". $_POST['cel'];
  $mensaje.= "\nTelefono: ". $_POST['tel'];
  ...
  $destino= "desarrolloit@odontopraxis.com.ar";
