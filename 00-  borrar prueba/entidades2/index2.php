...
<!--**************************************************-->
      ...
      <br />
      <br /> 
      <h2 align="center"> Ingreso Entidades  </h2>
 
 <form  method="POST" action="validarEntidad.php">
  <table border="0" cellspacing="0" cellpadding="0" align="center">
    <tr> 
      <td align="right" class="menu2_abm">Usuario</td>
      <td>&nbsp;&nbsp;</td>
      <td> 
  ...
  <p align="center">
    ...
    &nbsp;&nbsp;&nbsp;
     ...
     <input type="button" name="boton" value="Nuevo usuario" onclick="location='registroEntidad.php?accion=ALTA';" style="width:90px"/>
  </p>
  <div style="margin: 0 auto; width: 180px;"><a href="olvidoPassEntidad.php">Olvidé mi contraseña</a></div>
</form>
