...
?>
                              ...
                              <table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
                                ...
                                <tr> 
                                  <td valign="top"> 
                                    <?if ($col2_imagen != ''){?>
                                    <a href="nota_preview.php?id=<?=$col2_id?>"><img src="<?=NOTICIAS_DIR . $col2_imagen?>" width="70" height="53" border="0"></a> 
                                  </td>
                                  <td width="10">&nbsp; </td>
                                  <td bgcolor="9699AA" width="1"></td>
                                  <td width="10">&nbsp;</td>
								  <?}?>
                                  <td valign="top" width="100%"><img src="bullet.jpg" width="7" height="7"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><font color="#000000"><a href="nota_preview.php?id=<?=$col2_id?>"> 
                                    ...
                                    <b><font color="9699AA"><a href="nota_preview.php?id=<?=$col2_id?>"><font color="9699AA"><span class="contenido">Ver 
