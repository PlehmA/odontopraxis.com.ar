...
if ($accion == 'ALTA_UPD')	{
	...
	?><META HTTP-EQUIV="Refresh" CONTENT="0; URL=abmTelefonosClientes.php"><?
	return;
}
...
if ($accion == 'MOD_UPD')	{
	...
	/////////////////////////////
	?><META HTTP-EQUIV="Refresh" CONTENT="0; URL=abmTelefonosClientes.php?accion=MOD&id=<?=$id?>"><?
	return;
}
...
if (($accion == 'MOD') || ($accion == 'ALTA'))	{
	...
	$page_title = "Alta de Telefonos Clientes";
	$err = "";
	...
	$backpage = "abmTelefonosClientes.php";
	...
	if ($accion == 'MOD')	{
		...
		$page_title = "Edici&oacuten de Telefonos de Clientes";
		$backpage = "abmTelefonosClientes.php";
...
<?if ($err != ''){?><p align="center" class="menu2_abm"><font color="red">Error: <b><?=$err?></b></font></p><?}?>
 ...
 <form method="post" action="abmTelefonosClientes.php?accion=<?=$targetAction?>&id=<?=$id?>" name="data" enctype="multipart/form-data">
 <input type="hidden" name="id" value="<?=$id?>">
   ...
   <table border="0" cellspacing="0" cellpadding="0" align="center">
      ...
      <tr> 
        <td valign="middle" align="right" class="menu2_abm">Observaci&oacuten&nbsp;&nbsp;</td>
        <td valign="top" > 
...
<p align=center><b><font face="Arial, Helvetica, sans-serif" size="3">Listado de Telefonos Clientes</b></p>

<p align=center>
	<input type="button" name="boton" value="Nuevo telefono" onclick="location='abmTelefonosClientes.php?accion=ALTA';" style="width:150px"/>
	&nbsp;&nbsp;&nbsp;
...
?>
		<tr height="25">
		    <td class="txt_abm">&nbsp;</td>
		    <td nowrap>
		    	<img src="img/edit_icon.gif" style="cursor:hand" onclick="javascript:location='abmTelefonosClientes.php?accion=MOD&id=<?=$id?>'" alt="Editar">
		    </td>
		    <td nowrap>
...
<script language="Javascript">
	...
	{
		window.location = "abmTelefonosClientes.php?orderby=" + param + "&rnd=" + Math.random();
	}
	function ordenar(param)
	{
		window.location = "abmTelefonosClientes.php?orderby=<?=$filtro_orderby?>&order=" + param + "&rnd=" + Math.random();
	}
	function borrar(id)	{
		var conf = confirm("�Est� seguro que desea eliminar el telefono?");
		if (conf)	{
			window.location="abmTelefonosClientes.php?accion=BAJA&id="+id;
		}
	}
</script>
