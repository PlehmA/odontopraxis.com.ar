...
if ($accion == 'ALTA_UPD')	{
	...
	?>
<META HTTP-EQUIV="Refresh" CONTENT="0; URL=noticias_ing.php">
<?
	return;
}
...
//	print "sql: $sql<br>";
	...
	/////////////////////////////
	?>
<META HTTP-EQUIV="Refresh" CONTENT="0; URL=noticias_ing.php?accion=MOD&id=<?=$id?>">
<?
	return;
}
...
<font face="Arial, Helvetica, sans-serif" size="3"> <form method="post" action="noticias_ing.php?accion=<?=$targetAction?>&id=<?=$id?>" name="data" enctype="multipart/form-data"> 
...
<p align=center>
	<input type="button" name="boton" value="Nueva noticia" onclick="location='noticias_ing.php?accion=ALTA';" style="width:150px"/>
	&nbsp;&nbsp;&nbsp;
...
?>
		<tr height="25">
		    <td class="txt_abm">&nbsp;</td>
			<td nowrap>
		    	<img src="img/edit_icon.gif" style="cursor:hand" onclick="javascript:location='noticias_ing.php?accion=MOD&id=<?=$id?>'" alt="Editar">
		    </td>
		    <td nowrap>
		    ...
		    <td class="txt_abm" align="center">
		    	&nbsp;&nbsp;
		    	<?if ($publicado == 'S') {?>
		    		<input type="button" class="boton" name="pub1" value="No Publicar" onclick="location='noticias_ing.php?accion=PUBLICADONO&id=<?=$id?>'" style="height:17px">
		    	<?}else{?>
		    		<input type="button" class="boton" name="pub2" value="Publicar"  onclick="location='noticias_ing.php?accion=PUBLICADOSI&id=<?=$id?>'" style="height:17px">
		    	<?}?>
		    </td>
		    ...
		    <td nowrap>
		    	<img src="img/preview_icon.gif" style="cursor:hand" onclick="javascript:window.open('../ing/index_preview.php?id=<?=$id?>','_blank')" alt="Preview">
		    </td>
		    <td class="txt_abm">&nbsp;</td>
		</tr>
		<tr>
...
<script language="Javascript">
	function borrar(id)	{
		...
		if (conf)	{
			window.location="noticias_ing.php?accion=BAJA&id="+id;
		}
	}
</script>
