...
if ($accion == 'ALTA_UPD')	{
	...
	$sql.= 						" mail, observacion, activo, interno, nombre)";
	$sql.= 				"VALUES ($indexId, '$titulo', ";
	$sql.= 						"'$direccion', '$telefono', '$mail', ";
	$sql.= 						"'$observacion', '$activo', '$interno', '$nombre' )";
...
if ($accion == 'MOD_UPD')	{
	...
	$sql.=			" activo='$activo' , interno='$interno' , nombre='$nombre' ";
	$sql.= " WHERE id='$id'";
	//print "sql: $sql<br>";
	mysql_query($sql);
...
<?if ($err != ''){?><p align="center" class="menu2_abm"><font color="red">Error: <b><?=$err?></b></font></p><?}?>
 ...
 <input type="hidden" name="id" value="<?=$id?>">
   ...
   <table border="0" cellspacing="0" cellpadding="0" align="center">
      ...
      <tr> 
        <td valign="middle" align="right" class="menu2_abm">Nombre, Apellido / Raz&oacute;n Social &nbsp;&nbsp;</td>
       <td valign="top" > 
      ...
      <tr> 
        ...
        <td valign="top" > 
          <input type="text" class="menu2_abm" name="telefono" size="30" maxlength="80" value="" onblur="this.value=Trim(this.value);">
        </td>
      </tr>
      <tr> 
        <td valign="middle" align="right" class="menu2_abm">Interno&nbsp;&nbsp;</td>
        <td valign="top" > 
          <input type="text" class="menu2_abm" name="interno" size="20" maxlength="20" value="" onblur="this.value=Trim(this.value);">
        </td>
      </tr>
      <tr> 
      ...
      <tr> 
        <td valign="middle" align="right" class="menu2_abm">Observaci&oacute;n&nbsp;&nbsp;</td>
        <td valign="top" > 
...
if ($accion == "LISTA")	{
	...
	$listHeaders = Array(
					...
					Array("titulo" => "NyA / Razon Social", "campo" => "nombre", "celdas" => "1"),
...
<script language="Javascript">
	...
	function borrar(id)	{
		var conf = confirm("Esta seguro que desea eliminar el telefono?");
		if (conf)	{
