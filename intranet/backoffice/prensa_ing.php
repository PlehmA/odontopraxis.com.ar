...
if ($accion == 'ALTA_UPD')	{
	...
	?>
<META HTTP-EQUIV="Refresh" CONTENT="0; URL=prensa_ing.php">
<?
	return;
}
...
//	print "sql: $sql<br>";
	...
	/////////////////////////////
	?>
<META HTTP-EQUIV="Refresh" CONTENT="0; URL=prensa_ing.php?accion=MOD&id=<?=$id?>">
<?
	return;
}
...
<font face="Arial, Helvetica, sans-serif" size="3"> <form method="post" action="prensa_ing.php?accion=<?=$targetAction?>&id=<?=$id?>" name="data" enctype="multipart/form-data"> 
        ...
        <tr> 
          ...
          <td valign="top" class="menu2_abm"> 
            <table border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td>&nbsp;&nbsp;&nbsp;</td>
                <td> <img src="<?=EVENTOS_DIR?><?=$imagen?>"/> </td>
                <td>&nbsp;&nbsp;&nbsp;</td>
                <td class="menu2_abm"> [
                  <?=EVENTOS_DIR?>
                  <b>
          ...
          <td colspan="3" align="center">
            <table>
              <tr> 
                ...
                <td valign="top" class="menu2_abm"> 
                  <?if ($archivo != "")	{?>
                  <input type="radio" name="archivo_archivo_cambio" value="N" checked onclick="document.getElementById('id.archivo_archivo').disabled=true;">
                  Sin cambios<br>
                  <input type="radio" name="archivo_archivo_cambio" value="B" onclick="document.getElementById('id.archivo_archivo').disabled=true;">
                  Borrar<br>
                  <input type="radio" name="archivo_archivo_cambio" value="S" onclick="document.getElementById('id.archivo_archivo').disabled=false;">
                  Sobre-escribir 
                  <?}else{?>
              ...
              <tr> 
                <td valign="top" align="right">&nbsp;</td>
                <td valign="top" style="<?=$RED_FONT?>"> &nbsp;&nbsp;Este archivo 
                  es opcional.<br>
                </td>
              </tr>
              <?
              ...
              <tr> 
                ...
                <td valign="top" class="menu2_abm"> 
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td>&nbsp;&nbsp;&nbsp;</td>
                      <td class="menu2_abm"> <a href="<?=EVENTOS_DIR?><?=$archivo?>" target="_blank">[
                        <?=EVENTOS_DIR?>
                        <b>
                        <?=$archivo?>
                        </b>]</a><br>
  ...
  <script language="JavaScript">
	...
	//	}
		...
		if (form.elements['bajada'].value == "")	{
			...
			alert("Debe ingresar el texto de la bajada en español.");
			return false;
		}
	
		if (form.elements['texto'].value == "")	{
			form.elements['texto'].focus();
			alert("Debe ingresar el contenido de la noticia en español.");
			return false;
		}
...
<html>
<head>
<title>Listado de Prensa y Eventos</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<link rel="stylesheet" href="styles.css" type="text/css">
</head>
...
<p align=center><b><font face="Arial, Helvetica, sans-serif" size="3">Listado de Prensa y Eventos</b></p>

<p align=center>
	<input type="button" name="boton" value="Nueva noticia" onclick="location='prensa_ing.php?accion=ALTA';" style="width:150px"/>
	&nbsp;&nbsp;&nbsp;
...
?>
		<tr height="25">
		    <td class="txt_abm">&nbsp;</td>
		    <td nowrap>
		    	<img src="img/edit_icon.gif" style="cursor:hand" onclick="javascript:location='prensa_ing.php?accion=MOD&id=<?=$id?>'" alt="Editar">
		    </td>
		    <td nowrap>
		    ...
		    <td class="txt_abm" align="center">
		    	&nbsp;&nbsp;
		    	<?if ($publicado == 'S') {?>
		    		<input type="button" class="boton" name="pub1" value="No Publicar" onclick="location='prensa_ing.php?accion=PUBLICADONO&id=<?=$id?>'" style="height:17px">
		    	<?}else{?>
		    		<input type="button" class="boton" name="pub2" value="Publicar"  onclick="location='prensa_ing.php?accion=PUBLICADOSI&id=<?=$id?>'" style="height:17px">
		    	<?}?>
		    </td>
		    ...
		    <td class="txt_abm" align="center">
			 ...
			 <td nowrap>
		    	<img src="img/preview_icon.gif" style="cursor:hand" onclick="javascript:window.open('../ing/prensa_preview.php?id=<?=$id?>','_blank')" alt="Preview">
		    </td>
...
<script language="Javascript">
	function borrar(id)	{
		var conf = confirm("¿Está seguro que desea eliminar la noticia?");
		if (conf)	{
			window.location="prensa_ing.php?accion=BAJA&id="+id;
		}
	}
</script>
