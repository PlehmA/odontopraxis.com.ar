...
include ('conect.php');
	...
	if (mysql_num_rows($res) > 0) {
		...
		//Empleado y RRhh no tienen bandeja de pedidos
		if($jerarquia == 3 || $jerarquia == 4){
			$_SESSION['bandejaPedidos']="N";
		}else{
			$_SESSION['bandejaPedidos']="Y";
		}

		//RRHH y Presidente no pueden hacer pedidos
		if($jerarquia == 1 || $jerarquia == 4){
			$_SESSION['hacerPedidos']="N";
		}else{
			$_SESSION['hacerPedidos']="Y";
		}
