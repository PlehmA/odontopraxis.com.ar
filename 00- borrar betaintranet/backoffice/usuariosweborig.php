...
if (($accion == 'MOD') || ($accion == 'ALTA'))	{
	...
	$error = $_GET['error'];
	if($error == 1){
		$err="Ya existe un usuario con el mismo email o nro de documento </br> Por favor intente nuevamenre";
	}
...
if ($accion == "LISTA")	{
	...
	$listHeaders = Array(
					...
					Array("titulo" => "Nro de Documento", "campo" => "nro_doc", "celdas" => "1"),
...
<table border="0" cellspacing="0" cellpadding="0" align="center">
	   ...
	   <td>&nbsp;&nbsp;</td>
	   <td class="txt2_abm" nowrap align="center">Dar Pemiso admin</td>
	   <td>&nbsp;</td>	
		</tr>
