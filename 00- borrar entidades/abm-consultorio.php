...
<div class="header" id="header">
  ...
  <div class="titulo-sector-autogestion" id="titulo-sector-autogestion">
    <p align="center">Alta / Baja / Actualización de  consultorios.</p>
    Por favor complete solo los  datos a actualizar o los datos completos para solicitar el alta de un nuevo consultorio.<br />
  </div>
</div>
<br />
<div class="wrap2" id="wrap2">
  ...
  <div class="col-iz2" id="col-iz2">
    <div class="menu-iz2" id="menu-iz2">
      ...
      <div class="inhibido" id="inhibido">&gt; ABM de consultorio</div>
