...
<div class="header" id="header">
  ...
  Alta de usuario sistema de Utilidades de Odontopraxis Americana</p>
</div>
...
if($mensaje != ""){
  ...
  $sql.=  "VALUES ('$clave', 'N', 'N', '$nombre', '$cuit', '$email', NOW(), '$tel')";
  //print $sql;
  $res = mysql_query($sql);
  if ($res){
  ...
  ?>
    <div style="margin: 0 auto;width: 463px;">
      ...
      La registración fue enviada a la empresa para su estudio. Recuerde que si no es prestador de Odontopraxis Americana deberá primeramente enviar su CV por CONTRATACION DE PROFESIONALES</br>
