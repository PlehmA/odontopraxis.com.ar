...
<br />
      ...
      <p>
      <div class="inhibido" id="inhibido">&gt; Envio de Cobertura Resp. Civil (Mala Praxis)</a></div>
      <a href="form-malapraxis.php"></a></p>
...
<div class="enviocvp" id="enviocvp">
  ...
  <form name='formulario' id='formulario' method='post' action='enviar6.php' target='_self' enctype="multipart/form-data">
    ...
    <p>MP:<br />
      <input name='MP' type='text' id='MP' size="3" />
    </p>
    ...
    <input name='asunto' type='text' id='asunto2' value="Comprobante de Cobertura de Responsabilidad Civil (Mala praxis)" size="60" />
    <br />
