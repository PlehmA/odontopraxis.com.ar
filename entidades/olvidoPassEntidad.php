...
<div class="header" id="header">
  ...
  Bienvenidos al sistema de Utilidades de Odontopraxis Americana<br />
  </p>
</div>
...
<?if ($err != ''){?><p align="center" class="menu2_abm"><font color="red">Error: <b><?=$err?></b></font></p><?}?>
 ...
 <form method="post" action="<?=$here?>?accion=<?=$targetAction?>" name="data" enctype="multipart/form-data">
        ...
        Email:&nbsp;&nbsp;
          ...
          <input type="text" class="menu2_abm" name="email" size="30" maxlength="55" value="" onblur="this.value=Trim(this.value);">
