...
listFiles("erp/PDF/".$cuit."/");
?>		
</table>
	<br>
	<hr>
	</div>
		<a href="entidades/entidades-home.php"><button class="btn btn-default btn-sm text-center">Volver</button></a>
</div>
<br>
...
<?php 
	...
	session_destroy();
	header("Location: entidades/index.php");
}
